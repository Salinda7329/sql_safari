{{-- resources/views/level7.blade.php --}}
@extends('layouts.app')

@section('title', 'Level 7 - Uva')
                        ...
                        function onClose() {
                            ...
                            if (data.success) {
                                ...
                                setTimeout(() => {
                                    if ({{ $task->id }} === 20) {
                                        showDialogueChain([
                                            { speaker: "alex", text: "Completed all Level 7 tasks." },
                                            {
                                                speaker: "professor",
                                                text: `🎖️ You earned the Level 7 badge.<br><br>
                                                       <button class='btn btn-success' onclick="awardBadge(7)">Get Badge</button>`,
