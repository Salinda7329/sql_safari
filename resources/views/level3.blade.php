{{-- resources/views/level3.blade.php --}}
@extends('layouts.app')

@section('title', 'Level 3 - Galle')

@section('content')
    <div class="level-screen">
        <div class="city-banner row">
            <div class="col-10">
                <h2>🏖️ Galle, Sri Lanka</h2>
            </div>
            <div class="col">
...
@section('scripts')
    <script>
        ...
        // ✅ Run query logic (same structure as Level 2)
                        ...
                        function onClose() {
                            ...
                            if (data.success) {
                                ...
                                setTimeout(() => {
                                    if ({{ $task->id }} === 10  ) {
                                        showDialogueChain([
                                            { speaker: "alex", text: "Completed all Level 3 tasks." },
                                            {
                                                speaker: "professor",
                                                text: `🎖️ You earned the Level 3 badge.<br><br>
                                                       <button class='btn btn-success' onclick="awardBadge(3)">Get Badge</button>`,
