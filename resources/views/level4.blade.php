{{-- resources/views/level4.blade.php --}}
@extends('layouts.app')

@section('title', 'Level 4 - Jaffna')

@section('content')
    <div class="level-screen">
        <div class="city-banner row">
            <div class="col-10">
                <h2>🌴 Jaffna, Sri Lanka</h2>
            </div>
            <div class="col">
...
@section('scripts')
    <script>
        ...
        // ✅ Run query logic (same structure as Level 3)
                            ...
                            if (data.success) {
                                ...
                                setTimeout(() => {
                                    if ({{ $task->id }} === 13) {
                                        showDialogueChain([{
                                                speaker: "alex",
                                                text: "Completed all Level 4 tasks."
                                            },
                                            {
                                                speaker: "professor",
                                                text: `🎖️ You earned the Level 4 badge.<br><br>
                                                       <button class='btn btn-success' onclick="awardBadge(4)">Get Badge</button>`,
