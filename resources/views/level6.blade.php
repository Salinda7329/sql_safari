{{-- resources/views/level6.blade.php --}}
@extends('layouts.app')

@section('title', 'Level 6 - Anuradhapura')

@section('content')
    <div class="level-screen">
        <div class="city-banner row">
            <div class="col-10">
                <h2>🏯 Anuradhapura, Sri Lanka</h2>
            </div>
            <div class="col">
                        ...
                        function onClose() {
                            ...
                            if (data.success) {
                                ...
                                setTimeout(() => {
                                    if ({{ $task->id }} === 18) {
                                        showDialogueChain([
                                            { speaker: "alex", text: "Completed all Level 6 tasks." },
                                            {
                                                speaker: "professor",
                                                text: `🎖️ You earned the Level 6 badge.<br><br>
                                                       <button class='btn btn-success' onclick="awardBadge(6)">Get Badge</button>`,
