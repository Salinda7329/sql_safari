{{-- resources/views/level5.blade.php --}}
@extends('layouts.app')

@section('title', 'Level 5 - Pasikuda')

@section('content')
    <div class="level-screen">
        <div class="city-banner row">
            <div class="col-10">
                <h2>🌊 Pasikuda, Sri Lanka</h2>
            </div>
            <div class="col">
                        ...
                        function onClose() {
                            ...
                            if (data.success) {
                                ...
                                setTimeout(() => {
                                    if ({{ $task->id }} === 16) {
                                        showDialogueChain([
                                            { speaker: "alex", text: "Completed all Level 5 tasks." },
                                            {
                                                speaker: "professor",
                                                text: `🎖️ You earned the Level 5 badge.<br><br>
                                                       <button class='btn btn-success' onclick="awardBadge(5)">Get Badge</button>`,
