{{-- resources/views/level9.blade.php --}}
@extends('layouts.app')

@section('title', 'Level 9 - Kurunegala')

@section('content')
    <div class="level-screen">
        <div class="city-banner row">
            <div class="col-10">
                <h2>🐘 Kurunegala, Sri Lanka</h2>
            </div>
            <div class="col">
                    ...
                    function onClose() {
                        ...
                        if (data.success) {
                            ...
                            setTimeout(() => {
                                if ({{ $task->id }} === 27) {
                                    showDialogueChain([
                                        { speaker: "alex", text: "Completed all Level 9 tasks." },
                                        {
                                            speaker: "professor",
                                            text: `🎖️ You earned the Level 9 badge.<br><br>
                                                   <button class='btn btn-success' onclick="awardBadge(9)">Get Badge</button>`,
