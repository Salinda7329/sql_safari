...
@section('title', 'Section 5 – Arrival in Pasikuda')
...
@section('content')
    <div class="level-screen"
        ...
        <div class="city-banner text-center" style="position:absolute; top:20px; left:50%; transform:translateX(-50%);">
            <h2 style="color:#ff6600;">Arrival in Pasikuda</h2>
        </div>
    ...
    {{-- Hidden form --}}
    <form id="intro-complete-form" action="{{ route('sql.intro.complete', ['level' => request()->route('level') ?? 5]) }}"
...
@section('scripts')
    ...
    <script>
        ...
        // Pasikuda introduction dialogues
        const dialogues = [
            {
                speaker: "nila",
                side: "left",
                text: "Welcome to Pasikuda! 🌊 Famous for its calm, shallow bay and golden beaches."
            },
            {
                speaker: "alex",
                side: "right",
                text: "I can’t wait to explore! Let’s dive into SQL tasks that help us learn more about tourists and bookings here."
            },
            {
                speaker: "ravi",
                side: "left",
                text: "In this level, we’ll use advanced filtering, INNER JOINs, and explore relationships between tables."
            },
            {
                speaker: "nila",
                side: "right",
                text: "Ready? Let’s begin the Pasikuda challenges and connect our data together!"
            }
        ];
        ...
        function onYouTubeIframeAPIReady() {
            player = new YT.Player('yt-player', {
                videoId: '_UB4P9qIO74', // <-- Replace with Pasikuda video ID
                playerVars: {
                    autoplay: 1,
                    mute: 1,
                    controls: 1,
