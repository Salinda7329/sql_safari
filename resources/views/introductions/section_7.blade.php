{{-- resources/views/sections/section_6.blade.php --}}
@extends('layouts.app')

@section('title', 'Section 7 – Arrival in Uva')
...
@section('content')
    <div class="level-screen"
        ...
        <div class="city-banner text-center" style="position:absolute; top:20px; left:50%; transform:translateX(-50%);">
            <h2 style="color:#ff6600;">Arrival in Uva</h2>
        </div>
    ...
    {{-- Hidden form --}}
    <form id="intro-complete-form" action="{{ route('sql.intro.complete', ['level' => request()->route('level') ?? 7]) }}"
...
@section('scripts')
    ...
    <script>
        ...
        // Uva introduction dialogues
        const dialogues = [{
                speaker: "nila",
                side: "left",
                text: "Welcome to Uva! 🌄 Known for its breathtaking hills, Ella Gap, and endless tea estates."
            },
            {
                speaker: "alex",
                side: "right",
                text: "The scenery is amazing! Let’s explore how SQL can reveal insights about tourists, tea production, and local businesses here."
            },
            {
                speaker: "ravi",
                side: "left",
                text: "In this level, you’ll work on GROUP BY, aggregate functions, and filtering data from multiple tables."
            },
            {
                speaker: "nila",
                side: "right",
                text: "Be ready — the Uva challenges will test your ability to summarize and analyze large datasets!"
            }
        ];
        ...
        function onYouTubeIframeAPIReady() {
            player = new YT.Player('yt-player', {
                videoId: 'hLYAecDT5uw', // <-- Uva Shorts video ID
                playerVars: {
                    autoplay: 1,
                    mute: 1,
                    controls: 1,
