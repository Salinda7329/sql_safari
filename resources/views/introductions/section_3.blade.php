...
@section('title', 'Section 2 – Arrival in Galle')
...
@section('content')
    <div class="level-screen"
        ...
        <div class="city-banner text-center" style="position:absolute; top:20px; left:50%; transform:translateX(-50%);">
            <h2 style="color:#ff6600;">Arrival in Galle</h2>
        </div>
...
@section('scripts')
    ...
    <script>
        ...
        // Level 3 dialogues (Arrival in Galle)
        const dialogues = [{
                speaker: "nila",
                side: "left",
                text: "We’ve arrived in Galle! The historic Galle Fort and the ocean breeze are breathtaking."
            },
            {
                speaker: "alex",
                side: "right",
                text: "I’m excited to explore the hotels and tourists here. Let’s look at how data can be sorted and filtered."
            },
            {
                speaker: "ravi",
                side: "left",
                text: "In this level, you’ll learn how to use ORDER BY, LIMIT, and NOT operators while working with real data."
            },
            {
                speaker: "nila",
                side: "right",
                text: "Once you’re ready, we can begin the Galle challenges."
            }
        ];
        ...
        function onYouTubeIframeAPIReady() {
            player = new YT.Player('yt-player', {
                videoId: 'ZBcDYRw4sbM', // <-- Galle Shorts video ID
                playerVars: {
                    autoplay: 1,
                    mute: 1, // autoplay works more reliably if muted initially
                    controls: 1,
                    rel: 0,
                    modestbranding: 1,
                    playsinline: 1,
