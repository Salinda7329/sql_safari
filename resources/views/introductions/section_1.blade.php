...
<script>
    ...
    const dialogues = [
        { speaker: "nila", side: "left", text: "🌴 Welcome, Alex! This is Sri Lanka — full of adventures and hidden treasures." },
        { speaker: "ravi", side: "right", text: "But first things first… after a long flight, you need a good hotel to rest." },
        { speaker: "alex", side: "left", text: "Hmm… but how do we choose the right one quickly?" },
        { speaker: "nila", side: "right", text: "There are hundreds of hotels in Colombo. Some are expensive, some are affordable." },
        { speaker: "ravi", side: "left", text: "Don’t worry! We’ll guide you. Together we’ll explore all options and meet new friends from around the world." },
        { speaker: "nila", side: "right", text: "Let’s start by exploring the hotels in Colombo. Ready to begin?" }
    ];
