{{-- resources/views/sections/section_7.blade.php --}}
@extends('layouts.app')

@section('title', 'Section 8 – Arrival in Ratnapura')
...
@section('content')
    <div class="level-screen"
        ...
        <div class="city-banner text-center" style="position:absolute; top:20px; left:50%; transform:translateX(-50%);">
            <h2 style="color:#ff6600;">Arrival in Ratnapura</h2>
        </div>
    ...
    {{-- Hidden form --}}
    <form id="intro-complete-form" action="{{ route('sql.intro.complete', ['level' => request()->route('level') ?? 8]) }}"
...
@section('scripts')
    ...
    <script>
        ...
        // Ratnapura introduction dialogues
        const dialogues = [
            {
                speaker: "nila",
                side: "left",
                text: "Welcome to Ratnapura! 💎 The City of Gems, famous for its sapphires and rich natural beauty."
            },
            {
                speaker: "alex",
                side: "right",
                text: "This place is sparkling with history and trade! Let’s see how SQL can reveal patterns in gem sales and exports."
            },
            {
                speaker: "ravi",
                side: "left",
                text: "In this level, you’ll practice working with SUM, COUNT, and joining datasets to analyze gem transactions."
            },
            {
                speaker: "nila",
                side: "right",
                text: "Get ready — Ratnapura’s challenges will shine a light on your ability to handle business data effectively!"
            }
        ];
        ...
        function onYouTubeIframeAPIReady() {
            player = new YT.Player('yt-player', {
                videoId: 'iUnUlv3xSyY', // <-- Ratnapura Shorts video ID
                playerVars: {
                    autoplay: 1,
                    mute: 1,
                    controls: 1,
