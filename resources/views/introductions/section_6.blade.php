{{-- resources/views/sections/section_5.blade.php --}}
@extends('layouts.app')

@section('title', 'Section 6 – Arrival in Anuradhapura')
...
@section('content')
    <div class="level-screen"
        ...
        <div class="city-banner text-center" style="position:absolute; top:20px; left:50%; transform:translateX(-50%);">
            <h2 style="color:#ff6600;">Arrival in Anuradhapura</h2>
        </div>
    ...
    {{-- Hidden form --}}
    <form id="intro-complete-form" action="{{ route('sql.intro.complete', ['level' => request()->route('level') ?? 6]) }}"
...
@section('scripts')
    ...
    <script>
        ...
        // Anuradhapura introduction dialogues
        const dialogues = [{
                speaker: "nila",
                side: "left",
                text: "Welcome to Anuradhapura! 🏯 The ancient capital, filled with sacred temples and centuries of history."
            },
            {
                speaker: "alex",
                side: "right",
                text: "It feels like walking through time. Let’s see how SQL can uncover insights about heritage sites and visitors here."
            },
            {
                speaker: "ravi",
                side: "left",
                text: "In this level, you’ll practice using complex JOINs, subqueries, and advanced filtering to answer real-world questions."
            },
            {
                speaker: "nila",
                side: "right",
                text: "Be prepared — the Anuradhapura challenges will test how well you can combine and analyze data!"
            }
        ];
        ...
        function onYouTubeIframeAPIReady() {
            player = new YT.Player('yt-player', {
                videoId: 'QDP1iVbP4VQ', // <-- Anuradhapura Shorts video ID
                playerVars: {
                    autoplay: 1,
                    mute: 1,
                    controls: 1,
